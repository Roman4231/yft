...
public class DynamicListView extends ListView {
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        ...
        SelectedExercises var=new SelectedExercises(((CreateCustomTraining) getContext()).selectedExercises.get(indexOne));
        ((CreateCustomTraining) getContext()).selectedExercises.set(indexOne,((CreateCustomTraining) getContext()).selectedExercises.get(indexTwo));
        ((CreateCustomTraining) getContext()).selectedExercises.set(indexTwo,var);
    }
...
//////////////////////////////myCode
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        show((TextView)view.findViewById(R.id.create_custom_training_row_amount),position,((TextView) view.findViewById(R.id.create_custom_training_row_name)).getText().toString());
    }
};

    public void show(final TextView tv,final int pos,final String exerciseName)
    {
        final Dialog d = new Dialog(getContext());
        d.setTitle("Reps");
        d.setContentView(R.layout.dialog);
        Button set = (Button) d.findViewById(R.id.dialog_set);
        Button cancel = (Button) d.findViewById(R.id.dialog_cancel);
        ...
        set.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                String str=exerciseName.replaceAll(" x4","");
                ((CreateCustomTraining) getContext()).selectedExercises.set(mCheeseList.indexOf(str),new SelectedExercises(exerciseName,np.getValue()));
                ((CreateCustomTraining) getContext()).adapter.notifyDataSetChanged();
                d.dismiss();
            }
        });
