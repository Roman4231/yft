...
import com.yft.admin.myapplication.TrainingActivity;
...
public class Main extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_begin=(Button) v.findViewById(R.id.btn_begin);

        quote.setText("\"The Way Get Started Is To Quit Talking And Begin Doing\"\n\nWalt Disney");
